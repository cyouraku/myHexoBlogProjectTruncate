...
public class Base32 {
	...
	private static Logger logger = Logger.getLogger(Base32.class.getName());
    ...
    private String[] convert2Dec(){
        ...
        for (int i = 0;i<originStr.length();i++){
            if (((i+1)%5) == 0){
                ...
                //Debug:
//                logger.info(String.format("binStr=%s",binStr));
                BigInteger src = new BigInteger(binStr, 2);
                list.add(src.toString());
            }
        }
        //Debug:
//        logger.info(String.format("list.toString()=%s",list.toString()));
    ...
    public static void main(String[] args){
        ...
        logger.info(base32.getBase32Str());
    }
